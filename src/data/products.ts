...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Elegante ramo de flores variadas con tonos púrpura y verdes intensos. Frescura y elegancia.',
    price: 39.95,
  ...
  },
  {
    id: '7',
    name: 'Ramo Precioso',
    description: 'Elegante presentación de rosas rojas en caja decorativa. Un ramo alegre y vibrante para cualquier ocasión.',
    price: 30,
    originalPrice: 69,
  ...
  },
  {
    ...
    description: 'Exquisito arreglo de rosas en tonos suaves presentado con elegancia. Lujo y sofisticación.',
    price: 69,
    image: '/images/products/ramo-4.png',
    category: 'ramos',
    occasion: ['amor', 'aniversario'],
  ...
  },
  {
    ...
    description: 'Romántica composición de rosas rojas con globo "Te quiero". El detalle perfecto para enamorar.',
    price: 30,
    image: '/images/products/ramo-7.png',
    category: 'ramos',
    occasion: ['amor'],
  ...
  },
  {
    id: '10',
    name: 'Ramo Premium',
    description: 'Impresionante pirámide de 50 rosas rojas. Para ocasiones verdaderamente especiales.',
    price: 85,
  ...
  // PLANTAS
  {
    id: '11',
    name: 'Orquídea Azul',
    description: 'Espectacular orquídea azul en composición decorativa. Una planta que florece durante meses.',
    price: 70,
  ...
  // OCASIONES ESPECIALES
  {
    ...
    description: 'Tierno arreglo con globos para celebrar la llegada de un nuevo miembro a la familia.',
    price: 65,
    image: '/images/products/centro-1.png',
  ...
  {
    id: '19',
    name: 'Centro Funerario',
    description: 'Imponente centro de rosas rojas para honrar la memoria de seres queridos. Diseño solemne y elegante.',
    price: 189,
    image: '/images/products/planta-1.png',
